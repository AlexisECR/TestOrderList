...
var Article = /** @class */ (function () {
    ...
    Article.prototype.createDivImage = function (img, article) {
    ...
    Article.prototype.createArticleDescription = function (title, category, article) {
    ...
    Article.prototype.createArticlePrice = function (price, existenceStock, article) {
    ...
    Article.prototype.addArticle = function (article) {
        var _a;
        (_a = document.getElementById("listArticles")) === null || _a === void 0 ? void 0 : _a.appendChild(article);
    };
    return Article;
}());
